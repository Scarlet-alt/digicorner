    ...
    <section className="relative min-h-[780px] md:min-h-[820px] lg:min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container relative z-20 py-32 md:py-36 lg:py-40">
        <div className="max-w-2xl space-y-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[rgba(196,137,106,0.08)] border border-[rgba(196,137,106,0.18)] text-[#C4896A] text-sm font-medium mb-6">
            <Sparkles className="w-4 h-4" />
            Digital Intelligence Agency
          </div>
          <h1 className="font-display text-5xl md:text-6xl lg:text-7xl leading-tight mb-6 text-white">
            We build the systems your business runs on.
          </h1>
          <p className="text-muted-foreground text-lg md:text-xl leading-relaxed max-w-xl">
            AI assistants, websites, booking flows, and automation — for businesses that are tired of doing everything manually.
          </p>
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link to="/solutions" className="border border-border bg-card/80 text-foreground font-semibold rounded-full px-8 py-4 hover:bg-card transition-all duration-300 inline-flex items-center justify-center gap-2">
              See What We Build <ChevronRight className="w-5 h-5" />
            </Link>
          </div>
        </div>
      </div>
        ...
        <div className="relative z-10 container">
          <div className="max-w-2xl mb-20">
            ...
            <h2 className="font-display text-4xl md:text-5xl leading-[1.05] text-off-white">
              Three things we build the most.
            </h2>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
              ...
              <div
                key={s.title}
                className="min-h-[220px] rounded-2xl border border-[rgba(255,255,245,0.08)] bg-[#0B1221] p-6 flex flex-col"
              >
          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_480px] items-start">
            <div className="lg:pr-8">
              ...
              <h2 className="font-display text-4xl md:text-5xl leading-[1.02] text-off-white mb-6">
                Built to make your business easier to run.
              </h2>
              <p className="text-muted-foreground leading-relaxed text-lg max-w-xl">
                We build the tools that make the client experience actually work.
              </p>
            </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-off-white leading-relaxed">
                    Stop losing time on repeated tasks. Follow-ups, reminders, forms, and reports can run cleaner.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-off-white leading-relaxed">
                    Make it easier for clients to reach you. A clear website, a working booking flow, or an AI assistant removes the back-and-forth.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-off-white leading-relaxed">
                    Keep your operations organized. Your tools, data, and workflows should work together — not against you.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="relative z-10 container">
          ...
          <div className="grid gap-6 lg:grid-cols-3 sm:grid-cols-2">
            {industries.map((industry, idx) => (
              <div key={industry.title} className="rounded-[2rem] border border-[rgba(255,255,245,0.08)] bg-[#0B1221] p-8 transition-all duration-500 hover:-translate-y-1 hover:border-primary/40">
      ...
      <section className="py-36 relative bg-[hsl(222,26%,11%)] border-y border-border">
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mb-12">
            ...
            <h2 className="font-display text-4xl md:text-5xl leading-[1.05]">A few of our most requested builds.</h2>
          </div>
          <div className="mb-10 text-sm text-muted-foreground max-w-2xl">
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-5">
            {process.map((p, idx) => (
              <div
                key={p.title}
                className="relative rounded-3xl border border-border/60 bg-[#0B1221] p-6 transition-all duration-500"
              >
          ...
          <div className="relative max-w-4xl mx-auto rounded-3xl p-14 md:p-24 overflow-hidden border border-[rgba(255,255,245,0.12)] bg-[rgba(11,18,33,0.92)] shadow-card">
            <div className="relative z-10 text-center">
              ...
              <p className="text-xl md:text-2xl text-off-white/75 mb-12 max-w-2xl mx-auto font-light">
                Tell us what your business needs. We'll figure out what to build and where to start.
              </p>
              <Link
                to="/book"
